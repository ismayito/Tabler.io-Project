    ...
    <Nav>
      <Div1>
        ...
        >
          <BiHome
            size={20}
            className="md:max-[992px]:hidden text-gray-500 mr-1"
          ></BiHome>{' '}
          Home
        </Link>
        <Div2>
          <IconPackage
            size={20}
            className="inline-block md:max-[992px]:hidden   text-gray-500  text-base"
          ></IconPackage>{' '}
          Interface
          <RiArrowDropDownLine
            size={20}
        ...
        >
          <IconCheckbox
            size={20}
            className="text-gray-500 mr-1 md:max-[991px]:hidden"
          ></IconCheckbox>{' '}
          Form Elements
        </Link>
        <div className="flex   dark:hover:text-white  md:max-[991px]:text-[16px] dark:text-white justify-between ml-1 mt-1 items-center gap-1 cursor-pointer pb-2">
          <div>
            <IconStar
              size={20}
              className="inline-block md:max-[991px]:hidden text-gray-500 mr-1"
            ></IconStar>{' '}
            Extra
          </div>
          <RiArrowDropDownLine
        ...
        <div className="flex justify-between  dark:hover:text-white  md:max-[991px]:text-[16px] dark:text-white  mt-1 ml-1 items-center gap-1 cursor-pointer pb-2">
          <div>
            <IconLayout
              size={20}
              className="md:max-[993px]:hidden inline-block text-gray-500 mr-1"
            ></IconLayout>
            Layout
          </div>
          <RiArrowDropDownLine
        ...
        >
          <IconGhost
            size={20}
            className=" md:max-[993px]:hidden text-gray-500 mr-1"
          ></IconGhost>{' '}
          2979 icons
        </Link>
        <div className="flex justify-between   dark:hover:text-white md:max-[991px]:text-[16px] dark:text-white ml-1 items-center gap-1 cursor-pointer pb-2">
          <div>
            <IconLifebuoy
              size={20}
              className="inline-block md:max-[993px]:hidden mr-1 text-gray-500"
            ></IconLifebuoy>
            Help
          </div>
          <RiArrowDropDownLine
      ...
      <form className="flex  items-center ml-0 mr-1 md:mt-2 md:mb-1">
        <AiOutlineSearch
          size={20}
          className="absolute  text-center text-base ml-2 mr-1 text-gray-500"
        ></AiOutlineSearch>
