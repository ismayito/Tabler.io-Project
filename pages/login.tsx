  ...
  return (
    <Div>
      ...
      <LogInCard>
        <LoginForm>
          ...
          <form>
            ...
            <div className="flex justify-between mt-3">
              ...
              <Link
                className="hover:underline underline:text-[#206bc4] text-[#206bc4] "
                href="/forgotpassword"
              >
                I forgot Password
              </Link>
        ...
        <OtherSignIn>
          <hr className="w-[49%] text-gray-200 dark:border-[#243049] " />
          <span className="text-gray-600 dark:text-gray-400 tracking-widest">
            0R
          </span>
          <hr className="w-[49%] dark:border-[#243049] text-gray-200" />
        </OtherSignIn>
        <LoginForm>
          <div className="flex gap-4 justify-center items-center">
            <ButtonSign type="submit" onClick={SignInWithGitHub}>
              <IconBrandGithub
                size={20}
                className="inline-block dark:text-gray-900"
              ></IconBrandGithub>
              Login with Github
            </ButtonSign>
